<template>
  <div :class="[modalMode?'':$style.container]" class="flex column">
    <span v-if="!modalMode" class="q-mt-lg" :class="$style.title">
      Заполним данные для карточки курсанта</span
    >
    <div v-if="!isPhotoSeted" class="flex" :class="$style.photo_wrap">
      ...
      <div class=" flex column">
        ...
        <span class="q-mt-sm" :class="$style.photo_description"
          >К карточке курсанта обязательно нужно привязать фотографию</span
        >
        <div class="q-mt-sm">
          <span
...
export default {
  ...
  mounted() {
    this.data = JSON.parse(JSON.stringify(this.$store.state.studentInfo));
    this.isPhotoSeted = Boolean(this.avatar);
  },
  ...
  methods: {
    ...
    saveButtonHandler() {
      this.$store.commit("studentInfo/setPassportAddress", this.data.passportAddress);
      this.$store.commit("studentInfo/setPassportCode", this.data.passportCode);
      this.$store.commit("studentInfo/setPassportPlace", this.data.passportPlace);
      this.$store.commit("studentInfo/setPassportDate", this.data.passportDate);
      this.$store.commit("studentInfo/setPassportNumber", this.data.passportNumber);
      this.$store.commit("studentInfo/setBirthDate", this.data.birthDate);
      this.$store.commit("studentInfo/setEmail", this.data.email);
      this.$store.commit("studentInfo/setPhone", this.data.phone);
      this.$store.commit("studentInfo/setSurname", this.data.surname);
      this.$store.commit("studentInfo/setName", this.data.name);
      this.$store.commit("studentInfo/setAvatar", this.data.avatar);
